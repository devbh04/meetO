...
class PersonaMeetBot:
    ...
    def __init__(self, meet_url: str, audio_file: str = "sample.mp3",
                 ...
                 custom_insights_prompt: str = None):
        ...
        self.custom_insights_prompt: str | None = custom_insights_prompt
    ...
    async def _run_post_meeting_pipeline(self):
        ...
        if self.custom_insights_prompt:
            metadata["custom_insights_prompt"] = self.custom_insights_prompt
...
async def main():
    ...
    parser.add_argument(
        "--insights", default=None, metavar='"PROMPT"',
        help="Optional custom prompt for extracting specific insights from the meeting "
             '(e.g. --insights "Extract any mentions of budget, timeline, or risk")',
    )
    ...
    bot = PersonaMeetBot(
        ...
        bot_name=args.name,
        custom_insights_prompt=args.insights,
    )
    await bot.start()
